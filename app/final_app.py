...
@st.cache_resource
def load_models():
    index = faiss.read_index("/Users/nidhishgupta/Desktop/Movie_recommendation_sysytem/models/faiss.index")
    X_reduced = joblib.load("/Users/nidhishgupta/Desktop/Movie_recommendation_sysytem/models/movie_vectors_reduced.pkl")
